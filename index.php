...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">Ticket Tycoon</a>
            ...
            <ul>
                ...
                <li><a href="https://wa.me/7667472706?text=hii+please+help+me" class="nav-item">whatsapp me</a></li>
            </ul>
            <div>
    ...
    <section id="home">
        <div id="route-search-form">
            ...
            <p class="text-center">Welcome to Ticket Tycoon. Login now to manage Bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
            ...
            <center>
            <a href="OBRS-PHP\index.php"><button class="btn btn-danger " data-bs-toggle="modal">CLICK to Book</button>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                This website development is a part of min web project in this website currently will try to put admin login and later on customer login too ,will work with ai and at later stages will try to implement it on adroid app
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Ticket Tycoon | Made  by Raghav & Omkar 
                        </p>
        </footer>
    </div>
